...
| File | Description |
|---|---|
| [`Proyecto final Garmin metricas sueño.R`](Proyecto%20final%20Garmin%20metricas%20sueño.R) | R script with the full ETL, EDA and statistical modelling |
| [`Informe final.Rmd`](Informe%20final.Rmd) | R Markdown source of the final report |
| [`Proyecto final Rmarkdown.pdf`](Proyecto%20final%20Rmarkdown.pdf) | Rendered final report (PDF) |

## Tech stack

R · R Markdown · Linear Regression · PCA · Data Cleaning · Exploratory Data Analysis · Garmin

## Disclaimer

Personal portfolio project based on my own self-tracked sleep data. Shared for
